...
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.AVERAGE_WEEKLY_HOURS;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_BENEFITS_DETAIL;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_EMPLOYED_FROM;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_EMPLOYED_TO;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_OCCUPATION;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_PAY_AFTER_TAX;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_PAY_BEFORE_TAX;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_PENSION_WEEKLY_CONTRIBUTION;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.NEW_PAY_BEFORE_TAX;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.NO_LONGER_WORKING;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WEEKS;
