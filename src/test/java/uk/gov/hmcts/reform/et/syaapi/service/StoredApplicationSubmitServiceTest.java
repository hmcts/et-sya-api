...
class StoredApplicationSubmitServiceTest {
    ...
    StoredApplicationSubmitServiceTest() {
    ...
    void shouldSubmitStoredApplicationShouldReturnCaseDetails() throws NotificationClientException {
        ...
        storedApplicationSubmitService.submitStoredApplication(TEST_SERVICE_AUTH_TOKEN, testRequest);
