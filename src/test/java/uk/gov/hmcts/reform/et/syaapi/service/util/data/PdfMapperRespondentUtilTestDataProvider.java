...
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.TEST_ACAS;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.TEST_COMPANY_NAME;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_ADDRESS_LINE_1;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_ADDRESS_LINE_2;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_ADDRESS_LINE_3;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_COUNTRY;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_COUNTY;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_POSTCODE;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.WORK_POST_TOWN;
