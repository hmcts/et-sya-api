...
class StoredTribunalRequestServiceTest {
    ...
    StoredTribunalRequestServiceTest() {
    ...
    void before() {
        ...
        storedTribunalRequestService = new StoredTribunalRequestService(
            caseService,
    ...
    void submitRespondToTribunalShouldReturnCaseDetails() {
        ...
        storedTribunalRequestService.submitRespondToTribunal(TEST_SERVICE_AUTH_TOKEN, testRequest);
