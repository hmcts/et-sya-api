...
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.MISS;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.MR;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.MRS;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.MS;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.OTHER;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.OTHER_SPECIFY;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.SEX_FEMALE;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.SEX_MALE;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.SEX_PREFER_NOT_TO_SAY;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.TITLES;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.TITLE_MAP;
import static uk.gov.hmcts.reform.et.syaapi.service.util.PdfMapperConstants.YES;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_CONTACT_EMAIL_FIELD_NAME;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_EMAIL_FIELD_NAME;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_MOBILE_NUMBER_FIELD_NAME;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.CLAIMANT_PHONE_NUMBER_FIELD_NAME;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.EMAIL;
import static uk.gov.hmcts.reform.et.syaapi.service.util.TestConstants.OTHER_TITLE;
...
class PdfMapperPersonalDetailsUtilTest {
    ...
    @ParameterizedTest
    @MethodSource("uk.gov.hmcts.reform.et.syaapi.service.util.data.PdfMapperPersonalDetailsUtilTestDataProvider#"
