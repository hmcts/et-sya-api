...
this.dynatraceEntitySelectorAAT = 'type(service),tag(\\"[Kubernetes]namespace:et\\"),tag(\\"Environment:AAT\\"),entityName.equals(\\"ManageCaseController (AAT)\\")'
...
//Perftest Config
this.dynatraceSyntheticTestPerfTest = "HTTP_CHECK-0A7CF661E2924918"
...
this.dynatraceEntitySelectorPerfTest = 'type(service),tag(\\"[Kubernetes]namespace:et\\"),tag(\\"Environment:PERF\\"),entityName.equals(\\"ManageCaseController (PERF)\\")'
