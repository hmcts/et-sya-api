...
module "et-acas-mgmt-api" {
  ...
  swagger_url   = "https://raw.githubusercontent.com/hmcts/reform-api-docs/master/docs/specs/et-acas-api.json"
...
resource "azurerm_api_management_subscription" "et_acas_subscription" {
  ...
  user_id             = azurerm_api_management_user.et_api_management_user.user_id
